...
function fetchText(url, acceptHeader) {
  return new Promise((resolve, reject) => {
    const req = https.get(
      ...
      {
        headers: {
          "User-Agent": "importailer-netlify-function/1.0",
...
// Resuelve la cotizacion y devuelve { statusCode, payload } para que cada
// plataforma (Vercel / Netlify) lo adapte a su propio formato de respuesta.
